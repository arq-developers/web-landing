...
export default function StayInTheLoop() {
	const socialMedias = [
		{
			icon: <Broadcast size={28} weight="fill" color="#f7cb2d" />,
			href: "#",
			label: "Podcast",
		},
		{
			icon: <YoutubeLogo size={28} weight="fill" color="#f7cb2d" />,
			href: "#",
			label: "YouTube",
		},
		{
			icon: <InstagramLogo size={28} weight="fill" color="#f7cb2d" />,
			href: "#",
			label: "Instagram",
		},
		{
			icon: <FacebookLogo size={28} weight="fill" color="#f7cb2d" />,
			href: "#",
			label: "Facebook",
		},
	];
	...
	return (
		<section className="w-full py-16 flex flex-col items-center justify-center text-center gap-3 bg-blue-dark">
