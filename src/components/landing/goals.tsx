...
const GoalCard = ({
	...
	<div
		className={`bg-white rounded-sm shadow-lg flex flex-col justify-center items-center p-8 gap-2 flex-1 max-w-md cursor-default hover:shadow-blue/45 transition-all duration-300 group hover:bg-blue-dark ${className}`}
	>
...
export default function Goals() {
	...
	return (
		<div className="w-full h-full border-2 px-8 py-16 lg:px-16 flex flex-col justify-center items-center text-center gap-8 transition-all duration-300 ">
